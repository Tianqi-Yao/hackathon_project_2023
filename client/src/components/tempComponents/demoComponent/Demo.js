...
//       <button className="btn btn-primary" onClick={props.minusCount}>
//         Decrement
//       </button>
//       <button className="btn btn-primary" onClick={props.addCount}>
//         Increment
//       </button>
//       <button className="btn btn-primary" onClick={props.getUsers}>
//         getUsers
//       </button>
//       <button className="btn btn-primary" onClick={props.getMyApi}>
//         getMyApi
//       </button>
//     </div>
//   );
